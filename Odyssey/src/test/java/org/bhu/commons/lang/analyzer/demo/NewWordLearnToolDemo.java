 ...
 * 
 */
public class NewWordLearnToolDemo {
	
	@Test
	public void NewWordLearnTool() throws FileNotFoundException, IOException, ClassNotFoundException {

		// 构建一个新词学习的工具类。这个对象。保存了所有分词中出现的新词。出现次数越多。相对权重越大。
		LearnTool learnTool = new LearnTool();

		// 进行词语分词。也就是nlp方式分词，这里可以分多篇文章
		System.out.println(NlpAnalysis.parse("其实可以打着这个需求点去运作的互联网公司不应只是社交类软件与可穿戴设备，还有携程网，去哪儿网等等，订房订酒店多好的寓意"));
		System.out.println(NlpAnalysis.parse("脑洞该如何质疑互联网公司？"));
		NlpAnalysis.parse("该如何质疑互联网公司？", learnTool);
		NlpAnalysis.parse("互联网公司脑洞的营业收入？", learnTool);
		NlpAnalysis.parse("说过，社交软件也是打着沟通的平台，让无数寂寞男女有了肉体与精神的寄托。", learnTool);
		NlpAnalysis.parse("其实脑洞可以打着这个需求点去运作的互联网公司不应只是社交类软件与可穿戴设备，还有携程网，去哪儿网等等，订房订酒店多好的寓意", learnTool);
...
//		IOUtil.Writer("D:/1/learnTool.snap", IOUtil.UTF8, sb.toString());
//		sb = null;
//
//		/**
//		 * reload训练结果
...
//		HashMap<String, Double> loadMap = IOUtil.loadMap("D:/1/learnTool.snap", IOUtil.UTF8, String.class, Double.class);
